...
const ProductsHealth = () => {
    ...
    return (
      <Card sx={{ backgroundColor: "white", padding: "20px", margin: "15px" }}>
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          <h1 style={{ fontSize: "25px" }}>Health and Wellness Near You</h1>
        </div>
        <Box
          sx={{
  ...
  return (
    <Card sx={{ backgroundColor: "white", padding: "20px", margin: "15px" }}>
      ...
      >
        {(displayAllProducts
          ? productsList.filter(product => product.productCategory === "Health and Wellness")
          : productsList.filter(product => product.productCategory === "Health and Wellness").slice(0, productsPerPage)
