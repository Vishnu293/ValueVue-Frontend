...
const ProductsElectronic = () => {
  ...
  return (
    <Card sx={{ backgroundColor: "white", padding: "20px", margin: "15px" }}>
      ...
      >
        {(displayAllProducts
          ? productsList.filter(product => product.productCategory === "Electronics")
          : productsList.filter(product => product.productCategory === "Electronics").slice(0, productsPerPage)
