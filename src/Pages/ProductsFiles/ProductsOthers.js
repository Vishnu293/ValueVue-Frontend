...
const ProductsOthers = () => {
    ...
    return (
      <Card sx={{ backgroundColor: "white", padding: "20px", margin: "15px" }}>
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          <h1 style={{ fontSize: "25px" }}>Other Products Near You</h1>
        </div>
        <Box
          sx={{
  ...
  return (
    <Card sx={{ backgroundColor: "white", padding: "20px", margin: "15px" }}>
      ...
      >
        {(displayAllProducts
          ? productsList.filter(product => product.productCategory === "Others")
          : productsList.filter(product => product.productCategory === "Others").slice(0, productsPerPage)
