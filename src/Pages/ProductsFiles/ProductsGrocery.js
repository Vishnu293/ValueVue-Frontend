...
const ProductsGrocery = () => {
    ...
    return (
      <Card sx={{ backgroundColor: "white", padding: "20px", margin: "15px" }}>
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          <h1 style={{ fontSize: "25px" }}>Grocery and Food Near You</h1>
        </div>
        <Box
          sx={{
  ...
  return (
    <Card sx={{ backgroundColor: "white", padding: "20px", margin: "15px" }}>
      ...
      >
        {(displayAllProducts
          ? productsList.filter(product => product.productCategory === "Grocery and Food")
          : productsList.filter(product => product.productCategory === "Grocery and Food").slice(0, productsPerPage)
