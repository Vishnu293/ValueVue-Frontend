...
const ProductsPersonal = () => {
    ...
    return (
      <Card sx={{ backgroundColor: "white", padding: "20px", margin: "15px" }}>
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          <h1 style={{ fontSize: "25px" }}>Beauty and Personal Care Near You</h1>
        </div>
        <Box
          sx={{
  ...
  return (
    <Card sx={{ backgroundColor: "white", padding: "20px", margin: "15px" }}>
      ...
      >
        {(displayAllProducts
          ? productsList.filter(product => product.productCategory === "Beauty and Personal Care")
          : productsList.filter(product => product.productCategory === "Beauty and Personal Care").slice(0, productsPerPage)
